...
W3DHEAlmm_med <- Saliva_withconfounds %>% filter(complete.cases(sal_DHEA_conc_ln_w,medcode_12,medcode_13,medcode_17, medcode_18,medcode_19,medcode_20,medcode_3,medcode_4,medcode_5,medcode_6,medcode_7,medcode_9))
W3DHEA_null_med <- lmer(sal_DHEA_conc_ln_w ~ 1 + (1 | SID), data=W3DHEAlmm_med, REML = F)
W3DHEA_medcode <- lmer(sal_DHEA_conc_ln_w ~ medcode_3+medcode_4+medcode_5+medcode_6+medcode_7+medcode_9+medcode_12+medcode_13+medcode_17+medcode_18+medcode_19+medcode_20+ (1 | SID), data=W3DHEAlmm_med, REML = F)
...
W3ESTlmm_med <- Saliva_withconfounds %>% filter(complete.cases(sal_EST_conc_ln_w,medcode_4,medcode_5,medcode_6,                                          medcode_7,medcode_9,medcode_12,medcode_13,medcode_17,medcode_18,
                                           medcode_19,medcode_20, medcode_3))
W3EST_null_med <- lmer(sal_EST_conc_ln_w ~ 1 + (1 | SID), data=W3ESTlmm_med, REML = F)
W3EST_medcode <- lmer(sal_EST_conc_ln_w ~ medcode_3+medcode_4+medcode_5+medcode_6+medcode_7+medcode_9+medcode_12+medcode_13+medcode_17+medcode_18+medcode_19+medcode_20+ (1 | SID), data=W3ESTlmm_med, REML = F)
